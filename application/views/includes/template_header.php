			...
			<div class="wrapper">
				...
				<ul class="menu-togglable">
					...
					<li class="header-nav-item">
						<span class="header-nav-item__container-for-link"><a class="header-nav-item__link" href="/catalog">Каталог</a></span>
						<ul class="sub-menu">
					...
					<li class="header-nav-item"><span><a class="header-nav-item__link" href="/about">О компании</a></span></li>
					<li class="header-nav-item"><span><a class="header-nav-item__link" href="/news">Новости</a></span></li>
					<li class="header-nav-item"><span><a class="header-nav-item__link" href="/shipment">Доставка и оплата</a></span></li>
					<li class="header-nav-item"><span><a class="header-nav-item__link" href="/contacts">Контакты</a></span></li>
				</ul>
			</div>
		</nav>
	</header>